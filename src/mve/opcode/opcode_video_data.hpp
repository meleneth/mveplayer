...
public:
    ...
    void pixel_poke(int x, int y, int palette_index, MoviePlayer &movie_player);
    void pixel_poke_2x2(int x, int y, int palette_index, MoviePlayer &movie_player);
    void pixel_poke_2x1(int x, int y, int palette_index, MoviePlayer &movie_player);
    void pixel_poke_1x2(int x, int y, int palette_index, MoviePlayer &movie_player);
